...
当前仓库已建立文档、前端、后端、SQL 与部署配置目录，并搭建了基础前后端框架、章节解析、剧本 YAML 初稿骨架、生成接口、YAML 校验接口、AI Provider 和前端 YAML 预览、结构化预览、标题/logline、场景基础信息与 beats 结构化编辑、同步状态提示、YAML 编辑、校验、复制、下载、本地文本导入能力。后续会逐步补充人物结构化编辑、更完整的双向同步和持久化能力。
